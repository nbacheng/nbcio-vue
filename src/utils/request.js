...
/**
 * 【指定 axios的 baseURL】
 * 如果手工指定 baseURL: '/nbcio-boot'
 * 则映射后端域名，通过 vue.config.js
 * @type {*|string}
 */
let apiBaseUrl = window._CONFIG['domianURL'] || "/nbcio-boot";
//console.log("apiBaseUrl= ",apiBaseUrl)

axios.defaults.headers['Content-Type'] = 'application/json;charset=utf-8' //add by nbacheng
// 创建 axios 实例
