...
<script>
import { finishedList, getDeployment, delDeployment, addDeployment, updateDeployment, exportDeployment, revokeProcess } from "@/views/flowable/api/finished";
  ...
  methods: {
    ...
    getList() {
      ...
      finishedList(this.queryParams).then(response => {
        this.finishedList = response.result.records;
