  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/test/cesShopGoods/list",
          delete: "/test/cesShopGoods/delete",
          deleteBatch: "/test/cesShopGoods/deleteBatch",
          exportXlsUrl: "/test/cesShopGoods/exportXls",
          importExcelUrl: "test/cesShopGoods/importExcel",
    ...
    methods: {
      ...
      getSuperFieldList(){
        let fieldList=[];
        fieldList.push({type:'string',value:'code',text:'商品编码',dictCode:''})
