  ...
  export default {
    ...
    data() {
      return {
        ...
        dbUrlMap: {
          // MySQL 数据库
          '1': { dbUrl: 'jdbc:mysql://127.0.0.1:3306/nbcio-boot?characterEncoding=UTF-8&useUnicode=true&useSSL=false' },
          //MySQL5.7+ 数据库
          '4': { dbUrl: 'jdbc:mysql://127.0.0.1:3306/nbcio-boot?characterEncoding=UTF-8&useUnicode=true&useSSL=false&tinyInt1isBit=false&allowPublicKeyRetrieval=true&serverTimezone=Asia/Shanghai' },
          // Oracle
          ...
          // Mariadb 数据库
          '5': { dbUrl: 'jdbc:mariadb://127.0.0.1:3306/nbcio-boot?characterEncoding=UTF-8&useSSL=false' },
          // Postgresql 数据库
          '6': { dbUrl: 'jdbc:postgresql://127.0.0.1:5432/nbcio-boot' },
          // 达梦 数据库
          '7': { dbUrl: 'jdbc:dm://127.0.0.1:5236/?nbcio-boot&zeroDateTimeBehavior=convertToNull&useUnicode=true&characterEncoding=utf-8' },
          // 人大金仓 数据库
          '8': { dbUrl: 'jdbc:kingbase8://127.0.0.1:54321/nbcio-boot' },
          // 神通 数据库
          '9': { dbUrl: 'jdbc:oscar://192.168.1.125:2003/nbcio-boot' },
          // SQLite 数据库
          '10': { dbUrl: 'jdbc:sqlite://opt/test.db' },
          // DB2 数据库
          '11': { dbUrl: 'jdbc:db2://127.0.0.1:50000/nbcio-boot' },
          // Hsqldb 数据库
          '12': { dbUrl: 'jdbc:hsqldb:hsql://127.0.0.1/nbcio-boot' },
          // Derby 数据库
          '13': { dbUrl: 'jdbc:derby://127.0.0.1:1527/nbcio-boot' },
          // H2 数据库
          '14': { dbUrl: 'jdbc:h2:tcp://127.0.0.1:8082/nbcio-boot' },
          // 其他数据库
          '15': { dbUrl: '' }
        }
      }
